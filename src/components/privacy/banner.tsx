...
const Banner = ({ title, date, text }: BannerProps) => {
  return (
    <section className="mx-4 lg:mx-20 my-5 bg-brand-secondary-600 h-[250px] lg:h-[348px] rounded-2xl text-white flex flex-col gap-y-4 items-center justify-center border border-[#C4B49C]">
