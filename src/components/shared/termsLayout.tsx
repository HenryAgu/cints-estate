...
export default function TermsLayout({ sections, fontClassName = "font-serif" }: TermsLayoutProps) {
      ...
      <main className="flex-1 lg:px-6 py-5 space-y-8 lg:space-y-10 overflow-y-auto scroll-smooth">
        {sections.map((section) => (
          <section key={section.id} id={section.id}>
            ...
            <p className={`${fontClassName} text-base lg:text-lg text-black font-light lg:leading-[180%]`}>
              {section.content}
            </p>
          </section>
        ))}
